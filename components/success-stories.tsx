...
const successStories = [
	...
	},
	{
		...
		img: "/placeholder.svg?height=40&width=40",
		testimonial:
			"Switched from a service company to a product company with 150% salary hike. Best decision ever!",
	},
	{
		name: "Priya Patel",
		img: "/placeholder.svg?height=40&width=40",
	...
	},
	{
		...
		img: "/placeholder.svg?height=40&width=40",
		testimonial:
			"The portfolio projects helped me stand out in interviews. Got placed in my dream company!",
	},
	{
		name: "Sahil Jain",
		img: "/placeholder.svg?height=40&width=40",
		testimonial:
			"The DSA training was top-notch. Cracked Microsoft interview in the first attempt!",
	},
]
...
export function SuccessStoriesSection() {
	...
	const firstRow = successStories.slice(
		0,
		Math.ceil(successStories.length / 2),
	)
	const secondRow = successStories.slice(
		Math.ceil(successStories.length / 2),
	)
